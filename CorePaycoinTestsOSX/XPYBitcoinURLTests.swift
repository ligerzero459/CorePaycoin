...
class XPYPaycoinURLTests: XCTestCase {

    func testExample() {
        // This is an example of a functional test case.
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T?amount=1.23450009&label=Hello%20world"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertTrue(bURL.isValidPaycoinURL, "Must be valid paycoin url")
        XCTAssertEqual(bURL.amount, 123450009, "Must parse amount formatted as XPY")
    ...
    func testCompatiblePaymentRequest() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T?amount=1.23450009&r=http://example.com/order-1000123"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertTrue(bURL.isValidPaycoinURL, "Must be valid paycoin url")
        XCTAssertEqual(bURL.amount, 123450009, "Must parse amount formatted as XPY")
        XCTAssertEqual(bURL.address!.string, "1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T", "Must parse address")
    ...
    func testNakedPaymentRequest() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:?r=http://example.com/order-1000123"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertTrue(bURL.isValidPaycoinURL, "Must be valid paycoin url")
    ...
    func testInvalidURL1() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:?x=something"))!
    ...
    func testInvalidURL2() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:?amount=1.2"))!
        XCTAssertFalse(bURL.isValid, "Must not be valid")
    ...
    func testMalformedURL1() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:xxxx"))
        XCTAssertNil(bURL, "Must not parse broken address")
    }
    
    func testMalformedURL2() {
        let bURL = XPYPaycoinURL(URL: NSURL(string: "http://example.com"))
        XCTAssertNil(bURL, "Must not parse other schemas than paycoin:")
    }

    func testOpenAssetsURL() {
        // This is an example of a functional test case.
        let bURL = XPYPaycoinURL(URL: NSURL(string: "openassets:akB4NBW9UuCmHuepksob6yfZs6naHtRCPNy?amount=123&asset=ALn3aK1fSuG27N96UGYB1kUYUpGKRhBuBC"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertFalse(bURL.isValidPaycoinURL, "Must not be valid paycoin url")
    ...
    func testOpenAssetsPaymentRequestURL() {
        // This is an example of a functional test case.
        let bURL = XPYPaycoinURL(URL: NSURL(string: "openassets:?r=http://example.com"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertFalse(bURL.isValidPaycoinURL, "Must not be valid paycoin url")
        XCTAssertTrue(bURL.isValidOpenAssetsURL, "Must be valid OA url")
    ...
    func testCompatibleOpenAssetsURL() {
        // This is an example of a functional test case.
        let bURL = XPYPaycoinURL(URL: NSURL(string: "paycoin:akB4NBW9UuCmHuepksob6yfZs6naHtRCPNy?amount=123&asset=ALn3aK1fSuG27N96UGYB1kUYUpGKRhBuBC"))!
        XCTAssertTrue(bURL.isValid, "Must be valid")
        XCTAssertFalse(bURL.isValidPaycoinURL, "Must not be valid paycoin url")
        XCTAssertTrue(bURL.isValidOpenAssetsURL, "Must be valid OA url")
        XCTAssertEqual(bURL.amount, 123, "Must parse amount")
