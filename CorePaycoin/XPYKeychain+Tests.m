...
@implementation XPYKeychain (Tests)
...
+ (void) testPaths
{
    XPYKeychain* keychain = [[XPYKeychain alloc] initWithExtendedKey:@"xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi"];
...
+ (void) testStandardTestVectors
{
     ...
     */
    {
        NSData* seed = XPYDataWithHexCString("000102030405060708090a0b0c0d0e0f");
        
        XPYKeychain* masterChain = [[XPYKeychain alloc] initWithSeed:seed];
        ...
        NSAssert([masterChain.identifier isEqual:XPYDataFromHex(@"3442193e1bb70916e914552172cd4e2dbc9df811")], @"");
        ...
        XPYKeychain* m0prv = [masterChain derivedKeychainWithPath:@"m/0'"];
        ...
        XPYKeychain* m0prv1pub = [masterChain derivedKeychainWithPath:@"m/0'/1"];
        ...
        XPYKeychain* m0prv1pub2prv = [masterChain derivedKeychainWithPath:@"m/0'/1/2'"];
        ...
        XPYKeychain* m0prv1pub2prv2pub = [m0prv1pub2prv derivedKeychainAtIndex:2];
        ...
        XPYKeychain* m0prv1pub2prv2pub1Gpub = [masterChain derivedKeychainWithPath:@"m/0'/1/2'/2/1000000000"];
     ...
     */
    {
        NSData* seed = XPYDataWithHexCString("fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b7875726f6c696663605d5a5754514e4b484542");
        
        XPYKeychain* masterChain = [[XPYKeychain alloc] initWithSeed:seed];

        //NSLog(@"identifier: %@ fingerprint: %@", masterChain.identifier, @(masterChain.fingerprint));
        NSAssert([masterChain.identifier isEqual:XPYDataFromHex(@"bd16bee53961a47d6ad888e29545434a89bdfe95")], @"");
        ...
        XPYKeychain* m0pub = [masterChain derivedKeychainAtIndex:0];
        ...
        XPYKeychain* m0pubFFprv = [m0pub derivedKeychainAtIndex:2147483647 hardened:YES];
        ...
        XPYKeychain* m0pubFFprv1 = [m0pubFFprv derivedKeychainAtIndex:1];
        ...
        XPYKeychain* m0pubFFprv1pubFEprv = [masterChain derivedKeychainWithPath:@"m/0/2147483647'/1/2147483646'"];
        ...
        XPYKeychain* m0pubFFprv1pubFEprv2 = [masterChain derivedKeychainWithPath:@"m/0/2147483647'/1/2147483646'/2"];
...
+ (void) testDeserializationWithKeychain:(XPYKeychain*)keychain
{
    XPYKeychain* pubchain = [[XPYKeychain alloc] initWithExtendedKey:keychain.extendedPublicKey];
    XPYKeychain* prvchain = [[XPYKeychain alloc] initWithExtendedKey:keychain.extendedPrivateKey];
...
{
    XPYKeychain* keychain = [[XPYKeychain alloc] initWithSeed:[@"stress test" dataUsingEncoding:NSUTF8StringEncoding]];
    for (int i = 0; i < 2*256; i++)
    {
        //#puts i # i=70 yields a zero-prefixed private key.
        XPYKey* key = [keychain keyAtIndex:i hardened:YES];
