...
@implementation XPYScript (Tests)
...
+ (void) runAllTests
{
    ...
    [self testValidPaycoinQTScripts];
    [self testInvalidPaycoinQTScripts];
}

+ (void) testP2SHMultisig
{
//    XPYTransaction* tx = [[XPYTransaction alloc] initWithData:XPYDataFromHex(@"")];

    XPYTransaction* tx = [[XPYTransaction alloc] initWithData:XPYDataFromHex(@"")];
//    XPYScript* redeemScript = [[XPYScript alloc] initWithData:XPYDataFromHex(@"52210378d430274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c7121026a361b855808aeba02d3143b3ec884f709b24d5391c515bd4eafd69d1afae337210355e9d91d63acb15a75c1a9205fc4c0a0878778e08e0a9ca22adb0c2c33fa880153ae")];
    XPYScript* outputScript = [[XPYScript alloc] initWithAddress:[XPYAddress addressWithString:@"2NDdMCpA9to3ayTkXJQ3DvfKuSxjyRtFG5S"]];
...
//    NSLog(@"tx = %@", tx.dictionary);
    ...
    {
        XPYScriptMachine* sm = [[XPYScriptMachine alloc] initWithTransaction:tx inputIndex:i];
        NSError* error = nil;
        BOOL r = [sm verifyWithOutputScript:outputScript error:&error];
        if (!r)
        {
            NSLog(@"XPYScriptMachine error: %@", error);
        }
...
+ (void) testMultisignatureScripts
{
    ...
    XPYKey* alice = [[XPYKey alloc] initWithPrivateKey:XPYHash256(XPYDataWithUTF8CString("alice"))];
    XPYKey* bob   = [[XPYKey alloc] initWithPrivateKey:XPYHash256(XPYDataWithUTF8CString("bob"))];
    XPYKey* carl  = [[XPYKey alloc] initWithPrivateKey:XPYHash256(XPYDataWithUTF8CString("carl"))];
    XPYKey* david = [[XPYKey alloc] initWithPrivateKey:XPYHash256(XPYDataWithUTF8CString("david"))];
    ...
    XPYTransaction* srcTx = [[XPYTransaction alloc] init];
    
    // Lets have a 2-of-3 multisig output.
    XPYTransactionOutput* srcTxOut = [[XPYTransactionOutput alloc] initWithValue:100 script:[[XPYScript alloc] initWithPublicKeys:pubkeys signaturesRequired:2]];
    [srcTx addOutput:srcTxOut];
    
    //NSLog(@"Script: %@", srcTxOut.script.string);

    XPYTransaction* dstTx = [[XPYTransaction alloc] init];
    
    // Add dummy output (we don't care where the coins will go)
    [dstTx addOutput:[[XPYTransactionOutput alloc] initWithValue:100]];
    
    XPYTransactionInput* dstTxIn = [[XPYTransactionInput alloc] init];
    ...
    XPYSignatureHashType hashtype = XPYSignatureHashTypeAll;
    ...
    {
        XPYScript* signatureScript = [[XPYScript alloc] init];
        ...
        XPYScriptMachine* sm = [[XPYScriptMachine alloc] initWithTransaction:dstTx inputIndex:0];
...
+ (void) testBinarySerialization
{
    // Empty script
    {
        NSAssert([[[XPYScript alloc] init].data isEqual:[NSData data]], @"Default script should be empty.");
        NSAssert([[[XPYScript alloc] initWithData:[NSData data]].data isEqual:[NSData data]], @"Empty script should be empty.");
    }
...
{
    //NSLog(@"tx = %@", XPYHexFromData(XPYReversedData(XPYDataFromHex(@"..."))));
    
    NSData* yrashkScript = XPYDataFromHex(@"");
    
    XPYScript* script = [[XPYScript alloc] initWithData:yrashkScript];
...
{
    XPYScript *script = [[XPYScript alloc] initWithData:XPYDataFromHex(@"76a9147ab89f9fae3f8043dcee5f7b5467a0f0a6e2f7e188ac")];
    ...
    {
        NSData* simsigData = [script simulatedSignatureScriptWithOptions:XPYScriptSimulationDefault].data;
        ...
        NSData* simsigData2 = [script simulatedSignatureScriptWithOptions:XPYScriptSimulationCompressedPublicKeys].data;
    ...
    NSAssert([base58address isEqualToString:@"1CXPYGivXmHQ8ZqdPgeMfcpQNJrqTrSAcG"], @"address should be correctly decoded");
    
    XPYScript* script2 = [[XPYScript alloc] initWithAddress:[XPYAddress addressWithString:@"1CXPYGivXmHQ8ZqdPgeMfcpQNJrqTrSAcG"]];
    ...
    
    {
        ...
        {
            NSData *privkey01 = [[XPYAddress addressWithString:privKeyB58] data];
        ...
        XPYPrivateKeyAddress* pkaddr = [XPYPrivateKeyAddress addressWithString:privKeyB58];
        NSData *privkey = pkaddr.data;
        
        NSAssert([privkey isEqual:key.privateKey], @"private key should be the same");
        
        XPYKey* key2 = [[XPYKey alloc] initWithPrivateKey:privkey];
//        XPYAddress* pubkeyAddress = [XPYPublicKeyAddress addressWithData:XPYHash160(key2.publicKey)];
//        XPYAddress* privkeyAddress = [XPYPrivateKeyAddress addressWithData:key2.privateKey];
...
//    @[@"2147483647 DUP ADD", @"4294967294 NUMEQUAL", @"NUMEQUAL must be in numeric range"],
    ...
    XPYScript* script = [[XPYScript alloc] initWithString:@"2147483648 0 OP_ADD"];
    
    NSAssert(script, @"should be valid script");
    
    XPYScriptMachine* scriptMachine = [[XPYScriptMachine alloc] init];
    scriptMachine.verificationFlags = XPYScriptVerificationStrictEncoding;
    scriptMachine.inputScript = script;
    
    NSError* error = nil;
    if (![scriptMachine verifyWithOutputScript:[[XPYScript alloc] initWithString:@"OP_NOP"] error:&error])
    {
//        NSLog(@"error: %@", error);
    }
    else
...
XPYTransaction* BuildCreditingTransaction(XPYScript* scriptPubKey) {
    XPYTransaction* txCredit = [[XPYTransaction alloc] init];
    txCredit.version = 1;
    txCredit.lockTime = 0;
    XPYTransactionInput* txin = [[XPYTransactionInput alloc] init];
    txin.previousHash = XPYZero256();
    txin.previousIndex = 0xffffffff;
    txin.coinbaseData = [[[XPYScript new] appendOpcode:OP_0] appendOpcode:OP_0].data;
...
XPYTransaction* BuildSpendingTransaction(XPYScript* scriptSig, XPYTransaction* txCredit) {
    XPYTransaction* txSpend =[[XPYTransaction alloc] init];
    txSpend.version = 1;
    txSpend.lockTime = 0;
    XPYTransactionInput* txin = [[XPYTransactionInput alloc] init];
    ...
    XPYTransactionOutput* txout = [[XPYTransactionOutput alloc] init];
    txout.script = [[XPYScript alloc] init];
    txout.value = 0;
...
+ (void) testValidPaycoinQTScripts
{
//    // 7f33a2f5ace097f071010d5105e7fd01f22c83d8d5daa741a41f2a630a2af23b
//    NSLog(@"crediting tx: %@", BuildCreditingTransaction([XPYScript new]).transactionID);
//    // add55eb99bb1f653ab822ea4177cb0f9673bcc5c2c4c729894ab0c626c8fa1e1
//    NSLog(@"spending tx:  %@", BuildSpendingTransaction([XPYScript new], BuildCreditingTransaction([XPYScript new])).transactionID);

    for (NSArray* tuple in [self validPaycoinQTScripts])
    {
        ...
        XPYScript* inputScript = [[XPYScript alloc] initWithString:inputScriptString];
        if (!inputScript)
        {
            // for breakpoint
            inputScript = [[XPYScript alloc] initWithString:inputScriptString];
        }
        XPYScript* outputScript = [[XPYScript alloc] initWithString:outputScriptString];
        if (!outputScript)
        {
            // for breakpoint
            outputScript = [[XPYScript alloc] initWithString:outputScriptString];
        }
        ...
        {
            NSLog(@"XPYScript validation error: %@ (%@)", error, comment);
...
+ (void) testInvalidPaycoinQTScripts
{
    for (NSArray* tuple in [self invalidPaycoinQTScripts])
    {
        NSString* inputScriptString = tuple[0];
        NSString* outputScriptString = tuple[1];
        NSString* comment = tuple.count > 2 ? tuple[2] : @"Script should not fail";
...
+ (NSArray*) invalidPaycoinQTScripts
{
    return @[
  @[@"", @""],
  @[@"", @"NOP"],
