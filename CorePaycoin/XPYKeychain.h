...
// https://github.com/paycoin/bips/blob/master/bip-0032.mediawiki
//
// XPYKeychain encapsulates either a pair of "extended" keys (private and public), or only a public extended key.
...
static const uint32_t XPYKeychainMaxIndex = 0x7fffffff;

@class XPYKey;
@class XPYBigNumber;
@class XPYAddress;
@class XPYNetwork;
@interface XPYKeychain : NSObject<NSCopying>
...
// Use XPYDataFromBase58Check() to convert from Base58 string.
...
@property(nonatomic, readonly) XPYKey* rootKey DEPRECATED_ATTRIBUTE;

// Instance of XPYKey that is a "head" of this keychain.
// If the keychain is public-only, key does not have a private component.
@property(nonatomic, readonly) XPYKey* key;
...
// Use XPYBase58CheckStringWithData() to convert to Base58 form.
...
// Equivalent to [[XPYKeychain alloc] initWithExtendedKey:keychain.extendedPublicKey]
@property(nonatomic, readonly) XPYKeychain* publicKeychain;
...
// Index must be less of equal XPYKeychainMaxIndex, otherwise throws an exception.
...
// This feature is used in XPYBlindSignature protocol.
...
@property(nonatomic, readonly) XPYKeychain* paycoinMainnetKeychain;

// Returns a subchain with path m/44'/1'
@property(nonatomic, readonly) XPYKeychain* paycoinTestnetKeychain;
