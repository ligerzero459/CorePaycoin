...
// Combined with XPYBigNumber arithmetic, you can do usual EC operations to manipulate private and public keys.
// Private key is a big integer (represented by raw NSData or XPYBigNumber).
// Public key is a point on the curve represented by XPYCurvePoint or XPYKey.
// XPYCurvePoint is mutable. There is no immutable counterpart.
@class XPYKey;
@class XPYBigNumber;
@interface XPYCurvePoint : NSObject <NSCopying>
...
@property(nonatomic, readonly) XPYBigNumber* x;
@property(nonatomic, readonly) XPYBigNumber* y;

// Returns the generator point. Same as [XPYCurvePoint alloc] init].
...
- (instancetype) add:(XPYCurvePoint*)point;
