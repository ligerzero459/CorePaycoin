...
@interface XPYTransactionInput : NSObject <NSCopying>
...
// Outpoint of this input (previous hash and output index). Corresponds to COutPoint class in paycoind.
@property(nonatomic) XPYOutpoint* outpoint;
...
@property(nonatomic) XPYScript* signatureScript;
