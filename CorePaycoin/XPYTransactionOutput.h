...
static uint32_t const XPYTransactionOutputIndexUnknown = 0xffffffff;
...
@interface XPYTransactionOutput : NSObject<NSCopying>
...
@property(nonatomic) XPYScript* script;
...
// Index of this output in its transaction. Default is XPYTransactionOutputIndexUnknown
