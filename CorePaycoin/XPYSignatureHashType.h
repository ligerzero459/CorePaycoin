...
#ifndef CorePaycoin_XPYSignatureHashType_h
#define CorePaycoin_XPYSignatureHashType_h
...
typedef NS_ENUM(unsigned char, XPYSignatureHashType)
{
    ...
    SIGHASH_ALL          = 1,
    XPYSignatureHashTypeAll = SIGHASH_ALL,
    ...
    SIGHASH_NONE         = 2,
    XPYSignatureHashTypeNone = SIGHASH_NONE,
    ...
    SIGHASH_SINGLE       = 3,
    XPYSignatureHashTypeSingle = SIGHASH_SINGLE,
    ...
    XPYSignatureHashTypeOutputMask = SIGHASH_OUTPUT_MASK,
    ...
    // E.g. a crowdfunding transaction with 100 XPY output can be signed independently by any number of people
    ...
    XPYSignatureHashTypeAnyoneCanPay = SIGHASH_ANYONECANPAY,
};
