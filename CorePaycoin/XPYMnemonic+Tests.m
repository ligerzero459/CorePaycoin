...
@implementation XPYMnemonic (Tests)
...
+ (void) testStandardTestVectors
{
    ...
    {
        NSData* entropy = XPYDataFromHex(tuple[0]);
        NSArray* words = [tuple[1] componentsSeparatedByString:@" "];
        NSData* seed = XPYDataFromHex(tuple[2]);
        ...
        {
            XPYMnemonic* mnemonic = [[XPYMnemonic alloc] initWithEntropy:entropy password:@"TREZOR" wordListType:XPYMnemonicWordListTypeEnglish];
            ...
            XPYMnemonic* mnemonic2 = [[XPYMnemonic alloc] initWithData:mnemonic.data];
            ...
            XPYMnemonic* mnemonic3 = [[XPYMnemonic alloc] initWithData:mnemonic.dataWithSeed];
        ...
        {
            XPYMnemonic* mnemonic = [[XPYMnemonic alloc] initWithWords:words password:@"TREZOR" wordListType:XPYMnemonicWordListTypeEnglish];
        ...
        {
            XPYMnemonic* mnemonic = [[XPYMnemonic alloc] initWithWords:words password:nil wordListType:XPYMnemonicWordListTypeEnglish];
        ...
        {
            XPYMnemonic* mnemonic = [[XPYMnemonic alloc] initWithWords:words password:@"TREZOR" wordListType:XPYMnemonicWordListTypeUnknown];
...
+ (void) testMnemonicsWithoutPassword
{
    ...
    NSData* seed = XPYDataFromHex(@"a359cf47a6ddcc581f28133062dbc4cfacfbd79703e167b2a61438bf9f89efe5f2f12f8d39aea44709a5913965be93a5f805c6c614dcbfe620bceb161f0018c4");

    XPYMnemonic* mnemonic = [[XPYMnemonic alloc] initWithWords:words password:nil wordListType:XPYMnemonicWordListTypeUnknown];
