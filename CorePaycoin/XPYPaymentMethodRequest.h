...
extern NSInteger const XPYPaymentMethodRequestVersion1;

@interface XPYPaymentMethodRequest : NSObject
...
@property(nonatomic, readonly, nonnull) XPYPaymentMethodDetails* details;
