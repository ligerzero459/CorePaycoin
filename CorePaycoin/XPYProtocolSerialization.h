...
@interface XPYProtocolSerialization : NSObject

// This implementation of variable-length integer is known as "CompactSize" in Satoshi code (PaycoinQT).
//
...
//
// Note: PaycoinQT later added VarInt which is different, more compact format
