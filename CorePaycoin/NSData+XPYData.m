...
- (NSData*) SHA1 { return XPYSHA1(self); }
- (NSData*) SHA256 { return XPYSHA256(self); }
- (NSData*) XPYHash256 { return XPYHash256(self); }

#if XPYDataRequiresOpenSSL
- (NSData*) RIPEMD160 { return XPYRIPEMD160(self); }
- (NSData*) XPYHash160 { return XPYHash160(self); }
#endif
...
- (NSString*) hex
{
    return XPYHexFromData(self);
}

- (NSString*) uppercaseHex
{
    return XPYUppercaseHexFromData(self);
}
...
+ (NSMutableData*) cryptData:(NSData*)data key:(NSData*)key iv:(NSData*)iv operation:(CCOperation)operation
{
    ...
    if (iv)
    {
        ...
        else
        {
            ...
            @throw [NSException exceptionWithName:@"NSData+XPY IV is invalid"
    ...
    else
    {
        ...
        //kCCOverflow         = -4306
        @throw [NSException exceptionWithName:@"NSData+XPY CCCrypt failed"
