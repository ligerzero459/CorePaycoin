...
//   XPYPublicKeyAddressTestnet, 
//   XPYPrivateKeyAddressTestnet, 
//   XPYScriptHashAddressTestnet.
//
@class XPYKey;
@class XPYNetwork;
@interface XPYAddress : NSObject

/*!
 * Allows subclasses to be instantiated by a call to a superclass: XPYAddress(string: "...")
 */
 ...
 */
@property(nonatomic, readonly, nonnull) XPYAddress* publicAddress;
...
@interface XPYPublicKeyAddress : XPYAddress
@end
@interface XPYPublicKeyAddressTestnet : XPYPublicKeyAddress
@end


// Private key in WIF format (5KQntKuhYWSRXNq... or L3p8oAcQTtuokSC..., base58-encoded)
@interface XPYPrivateKeyAddress : XPYAddress
...
// Returns XPYKey containing a key pair. Its public key is compressed as specified by the address.
@property(nonatomic, readonly, nonnull) XPYKey* key;
...
@end
@interface XPYPrivateKeyAddressTestnet : XPYPrivateKeyAddress
@end

// P2SH address (e.g. 3NukJ6fYZJ5Kk8bPjycAnruZkE5Q7UW7i8)
@interface XPYScriptHashAddress : XPYAddress
@end
@interface XPYScriptHashAddressTestnet : XPYScriptHashAddress
@end
