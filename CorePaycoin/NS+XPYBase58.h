...
// For documentation look into XPYBase58.h.
// They are also used in CorePaycoin unit tests.
@interface NSString (XPYBase58)
...
@interface NSMutableData (XPYBase58)
