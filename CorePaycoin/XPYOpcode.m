...
NSDictionary* XPYOpcodeForNameDictionary()
{
...
{
    NSDictionary* dict = XPYOpcodeForNameDictionary();
...
{
    NSNumber* number = opcodeName ? XPYOpcodeForNameDictionary()[opcodeName] : nil;
