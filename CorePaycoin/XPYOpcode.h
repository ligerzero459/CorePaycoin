...
// NSString* XPYNameForOpcode(XPYOpcode opcode);
// XPYOpcode XPYOpcodeForName(NSString* opcodeName);
// XPYOpcode XPYOpcodeForSmallInteger(NSInteger smallInteger);
// NSInteger XPYSmallIntegerFromOpcode(XPYOpcode opcode);
...
typedef NS_ENUM(unsigned char, XPYOpcode)
{
    ...
    // PaycoinQT executes all operators from OP_IF to OP_ENDIF even inside "non-executed" branch (to keep track of nesting).
