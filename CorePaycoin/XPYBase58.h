...
// Base58 is used for compact human-friendly representation of Paycoin addresses and private keys.
...
// See NS+XPYBase58.h for easy to use categories.
...
// It's mutable so you can clear it securely yourself.
char* XPYBase58CheckCStringWithData(NSData* data);
