...
@property(nonatomic, readonly) XPYKeychain* keychain;
...
// If `password` is nil, it is treated as an empty string.
// If `wordListType` is XPYMnemonicWordListTypeUnknown, checksum is not verified.
